...
<!-- <section class="content-header">
  ...
  <a href="{{ url('products/pdf') }}" class="btn btn-warning">Unduh PDF</a>
      ...
      <div class="input-group mb-3">
        ...
        <button type="submit" class="btn btn-outline-primary mr-1"><i class="fa fa-search"></i>
</button>
        <a href="{{ url('products') }}">
          <type button class="btn btn-outline-danger "><i class="fa fa-undo"></i></button>
      </div>
</form> -->
@endif
...
<tr>
  ...
  <div class="btn-group">
  @if (Auth::user()->role == 'admin')
    <a href="{{ route('products.edit', $products->id) }}" class="btn  btn-sm btn-outline-dark mr-1"><i class="fa fa-edit"></i></a>
